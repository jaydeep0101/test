...
if ($(".dark-version")[0]) {
  $(".light__screen").hide();
  $(".dark__screen").show();
  $(".product-feature__inside--box").hide();
  $(".product-feature__inside--box-new").show();
} else {
  $(".dark__screen").hide();
  $(".light__screen").show();

  $(".product-feature__inside--box-new").hide();
  $(".product-feature__inside--box").show();
}

$(document).ready(function(){
    $("#desktop-sub-menu").click(function(){
      $(".main-submenu").slideToggle("slow");
      $(".main-submenu.active ").slideToggle("slow");   
    });
  });

$(document).on("mouseover", ".main-submenu__item", function () {
...
document.getElementById("myInput").oninput = function myFunction() {
  $("#header__menu--search").css("border-bottom", "2px solid var(--text-100)");
};
...
$("#header__menu--search").error(function () {
...
document.getElementById("contact_name").oninput = function myFunction() {
  $(".contactform__form--inputbox-inner input").css("border-bottom", "2px solid var(--text-100)");
};
...
$(".contactform__form--inputbox-inner input").error(function () {
  $(this).css("border-bottom", "2px solid red");
...
document.getElementById("contact_email").oninput = function myFunction() {
  $(".contactform__form--inputbox-inner input").css("border-bottom", "2px solid var(--text-100)");
};
...
document.getElementById("contact_number").oninput = function myFunction() {
  $(".contactform__form--inputbox-inner input").css("border-bottom", "2px solid var(--text-100)");
};
...
document.getElementById("contact_message").oninput = function myFunction() {
  $(".contactform__form--inputbox-inner textarea").css("border-bottom", "2px solid var(--text-100)");
};
...
$(".contactform__form--inputbox-inner textarea").error(function () {
  $(this).css("border-bottom", "2px solid red");
